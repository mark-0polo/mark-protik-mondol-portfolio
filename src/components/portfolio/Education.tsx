...
export function Education() {
  return (
    <section id="education" className="py-24 px-6 bg-muted/20 border-y border-border/40">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          <span className="text-xs font-mono font-semibold text-foreground uppercase tracking-widest">Academic Background</span>
          <h2 className="font-display text-3xl md:text-5xl font-extrabold tracking-tight">Education & Status</h2>
        </div>
          ...
          {EDUCATION_DATA.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground mt-3 font-sans">{item.detail}</p>
              </motion.div>
            );
          })}
        </div>
